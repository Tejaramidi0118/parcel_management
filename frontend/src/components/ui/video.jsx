 ...
 * />
 */
import { BigPlayButton, ControlBar, PlayToggle, CurrentTimeDisplay, TimeDivider, DurationDisplay, FullscreenToggle, VolumeMenuButton, ProgressControl } from 'video-react';
import 'video-react/dist/video-react.css';
export default function Video({ className, src, poster, autoPlay = false, muted = false, controls = true, aspectRatio = 'auto' }) {
    return (<div className={`min-w-[100px] ${className}`} custom-component="video">
    <style>
        {`
...
`}
    ...
    <Player poster={poster} src={src} autoPlay={autoPlay} muted={muted} aspectRatio={aspectRatio}>
        <ControlBar disableDefaultControls autoHide disableCompletely={!controls}>
