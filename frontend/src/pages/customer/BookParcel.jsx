...
export default function BookParcel() {
    ...
    React.useEffect(() => {
        const calculateEstimate = async () => {
            ...
            try {
                ...
                const customerCity = cities.find(c => user.address_city && c.name.toLowerCase().includes(user.address_city.toLowerCase()));
    ...
    const customerCity = cities.find(c => user.address_city && c.name.toLowerCase().includes(user.address_city.toLowerCase()));
    return (<div className="min-h-screen flex items-center justify-center py-10 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary/5 via-background to-secondary/5">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2 p-4 bg-muted rounded-lg">
              ...
              <div className="text-sm text-muted-foreground space-y-1">
                ...
                {customerCity && (<p className="text-xs text-muted-foreground">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="weight_kg" name="weight_kg" type="number" min="0.1" step="0.1" placeholder="e.g. 2.5" value={formData.weight_kg} onChange={handleChange} className="pl-10" required/>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="dimensions" name="dimensions" type="text" placeholder="e.g. 30x20x15 cm" value={formData.dimensions} onChange={handleChange} className="pl-10"/>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              {cities.length === 0 ? (<div className="text-sm text-muted-foreground p-2 border rounded">
                  No cities available. Please add cities in admin panel or check backend connection.
                </div>) : (<Select value={formData.delivery_city_id || ""} onValueChange={(value) => {
            ...
            {(estimatedFare || expectedDate) && (<div className="p-4 bg-primary/5 border border-primary/20 rounded-lg space-y-2">
                ...
                {expectedDate && (<div className="flex items-center justify-between">
            ...
            <div className="space-y-4 border-t pt-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="recipient_name" name="recipient_name" value={formData.recipient_name} onChange={handleChange} placeholder="Full name" required/>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="recipient_phone" name="recipient_phone" type="tel" value={formData.recipient_phone} onChange={handleChange} placeholder="+91-9876543210" required/>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="recipient_address_street" name="recipient_address_street" value={formData.recipient_address_street} onChange={handleChange} placeholder="Street address"/>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="recipient_address_area">Area / Locality</Label>
                  <Input id="recipient_address_area" name="recipient_address_area" value={formData.recipient_address_area} onChange={handleChange} placeholder="Area or locality"/>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="recipient_address_city">City</Label>
                  <Input id="recipient_address_city" name="recipient_address_city" value={formData.recipient_address_city} onChange={handleChange} placeholder="City name"/>
                </div>
              </div>

              <div className="space-y-2">
                <Label htmlFor="recipient_address_pincode">Pincode</Label>
                <Input id="recipient_address_pincode" name="recipient_address_pincode" value={formData.recipient_address_pincode} onChange={handleChange} placeholder="e.g. 560001" maxLength={10}/>
              </div>
            </div>
