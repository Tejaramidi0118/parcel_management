...
export default function Tracking() {
    ...
    return (<div className="min-h-screen py-8">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Card className="mb-8">
          <CardContent className="pt-6">
            <div className="flex gap-2">
              <Input placeholder="Enter tracking code (e.g., TRK1001234567)" value={trackingCode} onChange={(e) => setTrackingCode(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && handleSearch()}/>
        ...
        {parcel && (<div className="space-y-6">
            <Card>
              <CardHeader>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      {parcel.items.map((item) => (<div key={item.id}>
