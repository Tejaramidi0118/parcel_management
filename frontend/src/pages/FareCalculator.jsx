...
export default function FareCalculator() {
    ...
    const calculateDistance = (city1Id, city2Id) => {
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Input id="weight" type="number" step="0.1" min="0.1" placeholder="Enter weight in kg" value={formData.weight} onChange={(e) => setFormData({ ...formData, weight: e.target.value })}/>
                </div>
          ...
          <div>
            <Card>
              ...
              <CardContent>
                {fare !== null ? (<div className="text-center py-6">
