    ...
    const values = [
        {
            icon: Target,
            title: 'Our Mission',
            description: 'To provide fast, reliable, and affordable courier services that connect people and businesses across India and beyond.',
        },
        {
            icon: Award,
            title: 'Excellence',
            description: 'We strive for excellence in every delivery, ensuring your parcels reach their destination safely and on time.',
        },
        {
            icon: Heart,
            title: 'Customer First',
            description: 'Our customers are at the heart of everything we do. We are committed to providing exceptional service and support.',
        },
        {
            icon: Users,
            title: 'Our Team',
            description: 'A dedicated team of professionals working around the clock to ensure seamless delivery experiences.',
        },
    ];
